<%@ Page Language="C#" AutoEventWireup="true" CodeFile="furni9.aspx.cs" Inherits="furni9" %>
...
&nbsp;<asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine"></asp:TextBox>
    ...
    <p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <img alt="" src="pics/furni9.jpg" style="width: 800px; height: 400px" /></p>
    <h1 itemprop="name" 
        ...
        Toston Roca Queen Bed with Storage in Provincial Teak Finish by Woodsworth</h1>
    <p itemprop="name" 
...
&nbsp;
        ...
        <ol style="box-sizing: border-box; list-style: none; padding: 0px; margin: 0px; width: 568px; border-collapse: collapse;">
            <li class="vip-rt-pric" 
                ...
                Retail Price:</label><span class="Apple-converted-space">&nbsp;</span><span 
                    ...
                    style="box-sizing: border-box;">Rs.1,04,499</strike></span></li>
            <li class="vip-our-pric" 
                ...
                Our Price:</label><span class="Apple-converted-space">&nbsp;</span><span id="Oprice" 
                    style="box-sizing: border-box; margin-left: 2px; padding: 0px 0px 0.15em; display: inline-block;">Rs.77,999</span></li>
            <li class="vip-off-pric" 
                ...
                Offer Price:</label><span class="Apple-converted-space">&nbsp;</span><span 
                    id="Ofprice" 
                    style="box-sizing: border-box; padding: 0px 0px 0.15em; display: inline-block;">Rs.58499<span 
    ...
    <div class="vip-savings" 
        ...
        <p class="vip-save-disc" 
            ...
            26,500 (Retail Discount) + Rs. 19,500 (Limited Time Coupon)</span></p>
    </div>
            ...
            <td class="style2">
                ...
                <p class="vip-dtl-desc" 
                    ...
                    <b style="box-sizing: border-box;">Dimensions:</b><span 
                        class="Apple-converted-space">&nbsp;</span>Mattress Size : 60 x 78(Not Included); 
                    Seating Height - 14</p>
                <p class="vip-dtl-desc" 
                    style="box-sizing: border-box; margin: 0px 0px 1em; font-size: 0.875em; font-weight: 600; color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">
                    <b style="box-sizing: border-box;">Weight:</b><span 
                        class="Apple-converted-space">&nbsp;</span>105 KG</p>
                <p class="vip-dtl-desc" 
                    style="box-sizing: border-box; margin: 0px 0px 1em; font-size: 0.875em; font-weight: 600; color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">
                ...
                <p class="vip-dtl-desc" 
                    ...
                    <b style="box-sizing: border-box;">Height:</b><span 
                        class="Apple-converted-space">&nbsp;</span>40.0 inches</p>
                <p class="vip-dtl-desc" 
                    style="box-sizing: border-box; margin: 0px 0px 1em; font-size: 0.875em; font-weight: 600; color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">
                ...
                <p class="vip-dtl-desc" 
                    ...
                    <b style="box-sizing: border-box;">Depth:</b><span 
                        class="Apple-converted-space">&nbsp;</span>84.0 inches</p>
                <p class="vip-dtl-desc" 
                    style="box-sizing: border-box; margin: 0px 0px 1em; font-size: 0.875em; font-weight: 600; color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">
                    <b style="box-sizing: border-box;">Seating Height:</b><span 
                        class="Apple-converted-space">&nbsp;</span>14</p>
                <p class="vip-dtl-desc" 
                    style="box-sizing: border-box; margin: 0px 0px 1em; font-size: 0.875em; font-weight: 600; color: rgb(51, 51, 51); font-family: &quot;Open Sans&quot;, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">
                    <b style="box-sizing: border-box;">Storage Details:</b><span 
                        class="Apple-converted-space">&nbsp;</span>Storage Type : Side Drawer<br 
                        style="box-sizing: border-box;" />
                    Number of Drawers : 2<br style="box-sizing: border-box;" />
                    Drawer Size : H 10.5 X W 30 X D 34 (Inches)</p>
            </td>
            <td>
                <p class="vip-dtl-hd" 
                ...
                <div class="vip-dtl-para" 
                    ...
                    <div class="vip-dtl-desc" 
                        ...
                        <p style="box-sizing: border-box; margin: 0.5em 0px; height: 109px;">
                        ...
                        <p style="box-sizing: border-box; margin: 0.5em 0px; height: 343px;">
